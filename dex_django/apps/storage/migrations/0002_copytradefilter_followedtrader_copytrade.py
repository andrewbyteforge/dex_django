    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copy_percentage', models.DecimalField(decimal_places=2, default=Decimal('5.0'), help_text='Percentage of portfolio to allocate (for percentage mode)', max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0.1')), django.core.validators.MaxValueValidator(Decimal('50.0'))])),
                ('fixed_amount_usd', models.DecimalField(blank=True, decimal_places=2, help_text='Fixed USD amount per trade (for fixed amount mode)', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('10.0'))])),
                ('max_position_usd', models.DecimalField(decimal_places=2, default=Decimal('1000.0'), help_text='Maximum position size in USD', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('50.0'))])),
                ('max_slippage_bps', models.PositiveIntegerField(default=300, help_text='Maximum slippage in basis points', validators=[django.core.validators.MinValueValidator(50), django.core.validators.MaxValueValidator(1000)])),
                ('max_risk_score', models.DecimalField(decimal_places=1, default=Decimal('7.0'), help_text='Maximum risk score threshold (1.0-10.0)', max_digits=3, validators=[django.core.validators.MinValueValidator(Decimal('1.0')), django.core.validators.MaxValueValidator(Decimal('10.0'))])),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['followed_trader', '-created_at'], name='copy_trades_followe_9b2aa7_idx'), models.Index(fields=['original_tx_hash'], name='copy_trades_origina_d817cf_idx'), models.Index(fields=['chain', 'token_address'], name='copy_trades_chain_8414e7_idx'), models.Index(fields=['status', '-created_at'], name='copy_trades_status_59da22_idx'), models.Index(fields=['is_paper', '-created_at'], name='copy_trades_is_pape_f6791f_idx')],
            },
        ),
    ]
